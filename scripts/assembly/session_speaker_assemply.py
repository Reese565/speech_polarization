...
phrases_classes = pd.read_csv("../../data/vocabulary/master_list.txt", sep = "|")
...
def session_phrases(session):
    ...
    speaker_phrases_df = pd.read_csv("../../data/hein-bound/byspeaker_2gram_" + session +".txt", sep = "|")

    # import speaker map for session X
    speaker_map_df = pd.read_csv("../../data/hein-bound/" + session + "_SpeakerMap.txt", sep = "|")
